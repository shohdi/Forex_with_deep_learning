...
if __name__ == "__main__":
    ...
    envTest = ForexEnv('minutes15_100/data/test_data.csv',True,True )
    envVal = ForexEnv('minutes15_100/data/train_data.csv',True,True )
    ...
    if exists(modelCurrentPath):
        ...
        tgt_net.sync()
    agent = ptan.agent.DQNAgent(lambda x: net.qvals(x), ptan.actions.EpsilonGreedyActionSelector(0.0075,ptan.actions.ArgmaxActionSelector()) , device=device)
